...
export interface SampleRequest {
  ...
  export const COUNTRIES = [
    ...
    'France', 'Netherlands', 'Sweden', 'Denmark', 'Norway', 'Italy',
    'Spain', 'Belgium', 'Switzerland', 'Austria', 'Japan', 'South Korea',
    'United Arab Emirates', 'Saudi Arabia', 'Singapore', 'New Zealand',
    'Ireland', 'Portugal', 'Finland', 'Poland', 'Czech Republic', 'Other'
  ];